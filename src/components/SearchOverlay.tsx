    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-0 z-[100] bg-foreground/20 backdrop-blur-md flex items-start justify-center pt-[20vh]"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-background rounded-2xl shadow-elevated w-full max-w-xl mx-4 overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center gap-3 px-5 py-4 border-b border-foreground/[0.05]">
                ...
                {filtered.map((product) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground capitalize">{product.category} · ₹{product.price.toLocaleString()}</p>
                    </div>
                  </Link>
                ))}
              </div>
