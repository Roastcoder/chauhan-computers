    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-[1440px] mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            {product.badge && (
              <span className="text-xs font-medium tracking-wide uppercase text-primary bg-primary/10 px-3 py-1 rounded-full mb-4 inline-block">
                {product.badge}
              </span>
            )}
            ...
            <p className="text-prose text-[17px] leading-relaxed mb-8">
              {product.description}
            </p>
            ...
            <div className="flex gap-3">
              ...
              <button className="w-14 h-14 flex items-center justify-center rounded-full bg-surface text-muted-foreground hover:text-foreground transition-colors">
