...
import { ArrowRight, Star, Mail, Laptop, Printer, Cpu, Camera } from "lucide-react";
            ...
            {categories.map((cat, i) => (
              <AnimatedSection key={cat.slug} delay={i * 0.08}>
                <Link
                  ...
                  className="group bg-background rounded-3xl p-6 flex flex-col items-center text-center shadow-ambient hover:shadow-elevated transition-all duration-500 hover:-translate-y-1"
                >
                  <motion.img
                    src={cat.image}
                    alt={cat.name}
              ...
              return (
                <AnimatedSection key={service.id} delay={i * 0.1}>
                  <Link to="/services" className="group block">
                    <div className="bg-background rounded-3xl overflow-hidden shadow-ambient hover:shadow-elevated transition-all duration-500 hover:-translate-y-1">
