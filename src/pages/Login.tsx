      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-10 text-white">
          ...
          <p className="text-lg text-white/80 mb-6 max-w-md">
            Your Trusted Tech Partner in Jaipur — Laptops, Desktops, Accessories & IT Solutions
          </p>
          <div className="flex flex-col gap-2 text-sm text-white/60">
            <div className="flex items-center gap-2">
              <MapPin className="w-4 h-4" />
              <span>Shop No B-5, Girdhar Marg, Malviya Nagar, Jaipur</span>
            </div>
            <div className="flex items-center gap-2">
              <Phone className="w-4 h-4" />
              <span>098297 21157</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <AnimatePresence mode="wait">
            {mode === "login" ? (
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-card rounded-xl text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30 border border-border"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-card rounded-xl text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30 border border-border pr-10"
                        placeholder="••••••••"
                        required
                      />
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-6">Sign up as a customer to get started</p>
