      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <a href="tel:09509317543" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors mb-1">
              <Phone className="w-3 h-3 text-primary" />
              95093 17543
            </a>
            <a href="tel:08559965655" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors mb-1">
              <Phone className="w-3 h-3 text-primary" />
              85599 65655
            </a>
            <a href="tel:09376721157" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground transition-colors">
              <Phone className="w-3 h-3 text-primary" />
              93767 21157 (Service)
            </a>
